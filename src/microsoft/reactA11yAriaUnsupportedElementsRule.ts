...
import * as domSchema from './utils/attributes/domSchema.json';
import * as ariaSchema from './utils/attributes/ariaSchema.json';

const DOM_SCHEMA: { [key: string]: IDom } = domSchema;
const ARIA_SCHEMA: { [key: string]: Partial<IAria> } = ariaSchema;
