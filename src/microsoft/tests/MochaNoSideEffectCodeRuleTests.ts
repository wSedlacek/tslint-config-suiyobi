...
describe('mochaNoSideEffectCodeRule', (): void => {
  ...
  it('should fail on complex cast', (): void => {
    ...
    TestHelper.assertViolations(ruleName, script, [
      {
        failure:
          'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): publisher: DTO.Publisher = <...',
  ...
  it('should fail on function calls', (): void => {
    ...
    TestHelper.assertViolations(ruleName, script, [
      {
        failure:
          'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): expect(convertedTags).to.dee...',
        name: Utils.absolutePath('file.ts'),
        ruleName: 'mocha-no-side-effect-code',
  ...
  it('should fail on describe', (): void => {
    ...
    TestHelper.assertViolations(ruleName, script, [
      {
        failure: 'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): VIOLATION1 = this.myMethod()',
        name: Utils.absolutePath('file.ts'),
        ruleName: 'mocha-no-side-effect-code',
        startPosition: { character: 23, line: 3 },
      },
      {
        failure: 'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): VIOLATION2 = new MyClass()',
        name: Utils.absolutePath('file.ts'),
        ruleName: 'mocha-no-side-effect-code',
      ...
      {
        failure:
          'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): VIOLATION3 = true ? false : ...',
        name: Utils.absolutePath('file.ts'),
        ruleName: 'mocha-no-side-effect-code',
      ...
      {
        failure:
          'Mocha test contains dangerous variable initialization. ' + "Move to before()/beforeEach(): VIOLATION4 = x || 'some value'",
        name: Utils.absolutePath('file.ts'),
        ruleName: 'mocha-no-side-effect-code',
  ...
  it('should fail on global scope', (): void => {
    ...
    TestHelper.assertViolations(ruleName, script, [
      {
        failure: 'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): VIOLATION1 = new MyClass()',
        name: Utils.absolutePath('file.ts'),
        ruleName: 'mocha-no-side-effect-code',
  ...
  describe('arrays', (): void => {
    ...
    it('should fail on complex arrays', (): void => {
      ...
      TestHelper.assertViolations(ruleName, script, [
        {
          failure: 'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): VIOLATION = [ someCall() ]',
          name: Utils.absolutePath('file.ts'),
          ruleName: 'mocha-no-side-effect-code',
          startPosition: { character: 23, line: 3 },
        },
  ...
  describe('Array.forEach', (): void => {
    ...
    it('should fail on Array.forEach of complex arrays', (): void => {
      ...
      TestHelper.assertViolations(ruleName, script, [
        {
          failure:
            'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): [ someCall() ].forEach((): v...',
          name: Utils.absolutePath('file.ts'),
          ruleName: 'mocha-no-side-effect-code',
    ...
    it('should fail on Array.forEach from function call', (): void => {
      ...
      TestHelper.assertViolations(ruleName, script, [
        {
          failure:
            'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): someCall().forEach((): void ...',
          name: Utils.absolutePath('file.ts'),
          ruleName: 'mocha-no-side-effect-code',
          startPosition: { character: 21, line: 3 },
        },
    ...
    it('should fail on Array.forEach with side effects in function', (): void => {
      ...
      TestHelper.assertViolations(ruleName, script, [
        {
          failure: 'Mocha test contains dangerous variable initialization. ' + 'Move to before()/beforeEach(): VIOLATION = new MyClass()',
          name: Utils.absolutePath('file.ts'),
          ruleName: 'mocha-no-side-effect-code',
