...
import { getFailureStringForNotImplicitRole, getFailureStringForImplicitRole } from '../reactA11yRoleHasRequiredAriaPropsRule';
    ...
    it('when explcit role missing required props', () => {
      ...
      TestHelper.assertViolations(ruleName, fileName, [
        ...
        },
        {
          ...
          failure: getFailureStringForNotImplicitRole(['menuitemcheckbox'], ['aria-checked']),
        },
        {
          name: fileName,
          ruleName: ruleName,
          startPosition: { character: 11, line: 5 },
          failure: getFailureStringForNotImplicitRole(['radio'], ['aria-checked']),
        },
        {
          name: fileName,
          ruleName: ruleName,
          startPosition: { character: 11, line: 6 },
          failure: getFailureStringForNotImplicitRole(['spinbutton'], ['aria-valuemax', 'aria-valuemin', 'aria-valuenow']),
        },
      ]);
    });
      ...
      TestHelper.assertViolations(ruleName, fileName, [
        {
          ...
          ruleName: ruleName,
          startPosition: { character: 11, line: 3 },
          failure: getFailureStringForImplicitRole('input', 'combobox', ['aria-expanded', 'aria-controls']),
        },
        {
          name: Utils.absolutePath('file.tsx'),
          ruleName: ruleName,
          startPosition: { character: 11, line: 4 },
          failure: getFailureStringForImplicitRole('menuitem', 'menuitemradio', ['aria-checked']),
        },
      ]);
    });
  });
