...
export class Rule extends Lint.Rules.TypedRule {
  public static metadata: Lint.IRuleMetadata = {
    ...
    descriptionDetails: 'See more at https://redux.js.org/style-guide/style-guide#avoid-dispatching-many-actions-sequentially',
    options: null,
  ...
  public static FAILURE_STRING = 'Avoid dispatching many actions in a row to accomplish a larger conceptual "transaction"';
