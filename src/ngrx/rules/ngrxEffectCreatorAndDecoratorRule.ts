...
export class Rule extends Lint.Rules.TypedRule {
  public static metadata: Lint.IRuleMetadata = {
    ...
    descriptionDetails: 'The Effect will fire twice when using both the creator function, as the decorator',
    options: null,
  ...
  public static FAILURE_STRING = 'Remove the `@Effect` decorator or the `createEffect` creator';
