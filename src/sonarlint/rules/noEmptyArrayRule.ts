...
export class Rule extends tslint.Rules.TypedRule {
  ...
  public applyWithProgram(sourceFile: ts.SourceFile, program: ts.Program): tslint.RuleFailure[] {
    ...
    getCollectionSymbols(symbols, program)
      ...
      .map((symbolAndDeclaration) => symbols.allUsages(symbolAndDeclaration.symbol).filter((usage) => !usage.is(UsageFlag.DECLARATION)))
...
const readCollectionPatterns: ((usage: Usage) => boolean)[] = [isStrictlyReadingMethodCall, isForIterationPattern, isElementRead];
