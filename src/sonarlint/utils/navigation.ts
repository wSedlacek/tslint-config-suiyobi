...
export function collectLeftHandIdentifiers(node: ts.Expression): { identifiers: ts.Identifier[]; nonIdentifiers: ts.Expression[] } {
...
export function firstAncestor(node: ts.Node, targetAncestor: ts.SyntaxKind[], ...boundary: ts.SyntaxKind[]): ts.Node | undefined {
...
export const LOOP_STATEMENTS = [Kind.ForStatement, Kind.ForInStatement, Kind.ForOfStatement, Kind.WhileStatement, Kind.DoStatement];
