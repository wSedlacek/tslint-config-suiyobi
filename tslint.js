...
module.exports = {
  ...
  rulesDirectory: utils_1.moduleSpecificArray({
    common: [
      utils_1.resolveRules('tslint-clean-code/dist/src'),
      'dist/microsoft',
      'dist/eslint/rules',
      'dist/sonarlint/rules',
      'dist/consistent-codestyle/rules',
    ],
    angular: [utils_1.resolveRules('codelyzer')],
    ngrx: ['dist/ngrx/rules'],
    nx: [utils_1.resolveRules('@nrwl/workspace/src/tslint')],
    override: [utils_1.resolveRules('tslint-override/rules')],
    prettier: [utils_1.resolveRules('tslint-plugin-prettier')],
    rxjs: [utils_1.resolveRules('rxjs-tslint-rules/dist/rules')],
  }),
  rules: utils_1.moduleSpecificObject({
    common: {
      align: true,
  ...
  jsRules: utils_1.moduleSpecificObject({
    prettier: {
      align: false,
      'array-bracket-spacing': false,
      'arrow-parens': false,
