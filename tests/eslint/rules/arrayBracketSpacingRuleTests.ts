...
ruleTester.addTestGroup('invalid', 'simple invalid space test', [
  {
    ...
    output: 'var foo = []',
    options: ['never'],
    errors: expecting([[0, 10, false, 'after']]),
  },
]);
...
ruleTester.addTestGroup('invalid-single-value', 'should handle single value exceptions', [
  ...
  },
  {
    ...
    output: "var obj = ['foo'];",
    options: ['always', { singleValue: false }],
    errors: expecting([[0, 17, false, 'before']]),
  },
  {
    code: "var obj = ['foo'];",
    output: "var obj = [ 'foo' ];",
...
ruleTester.addTestGroup('always-arr-in-arr', 'should handle array and arrays exception', [
  ...
  },
  {
    ...
    output: 'var arr = [ 1, 2, 2, [ 3, 4 ]];',
    options: ['always', { arraysInArrays: false }],
    errors: expecting([[0, 30, false, 'before']]),
  },
  {
    code: 'var arr = [[ 1, 2 ], 2, [ 3, 4 ] ];',
    output: 'var arr = [[ 1, 2 ], 2, [ 3, 4 ]];',
    options: ['always', { arraysInArrays: false }],
    errors: expecting([[0, 33, false, 'before']]),
  },
  {
    code: 'var arr = [ [ 1, 2 ], 2, [ 3, 4 ]];',
    output: 'var arr = [[ 1, 2 ], 2, [ 3, 4 ]];',
...
ruleTester.addTestGroup('always-destructuring', 'should array destructuring', [
  ...
  },
  {
    ...
    output: 'var [ x,y ] = y',
    options: ['always'],
    errors: expecting([[0, 4, true, 'after']]),
  },
  {
    code: 'var [,,,x,,] = y',
    output: 'var [ ,,,x,, ] = y',
  ...
  },
  {
    ...
    output: 'var [ ,,,x,, ] = y',
    options: ['always'],
    errors: expecting([[0, 12, true, 'before']]),
  },
  {
    code: 'var [...horse] = y',
    output: 'var [ ...horse ] = y',
  ...
  },
  {
    ...
    options: ['always', { arraysInArrays: false }],
    errors: expecting([[0, 4, false, 'after']]),
  },
  {
    code: '[ { x, y }, z ] = arr;',
    output: '[{ x, y }, z ] = arr;',
    options: ['always', { objectsInArrays: false }],
    errors: expecting([[0, 0, false, 'after']]),
  },
  {
    code: '[ x, { y, z } ] = arr;',
    output: '[ x, { y, z }] = arr;',
    options: ['always', { objectsInArrays: false }],
    errors: expecting([[0, 14, false, 'before']]),
  },
]);
...
ruleTester.addTestGroup('always-fail', 'should handle always', [
  ...
  },
  {
    ...
    output: 'var arr = [ 1, 2, 3, 4 ];',
    options: ['always'],
    errors: expecting([[0, 10, true, 'after']]),
  },
  {
    code: 'var arr = [ 1, 2, 3, 4];',
    output: 'var arr = [ 1, 2, 3, 4 ];',
    options: ['always'],
    errors: expecting([[0, 22, true, 'before']]),
  },
]);
...
ruleTester.addTestGroup('never-fail', 'should handle never', [
  ...
  },
  {
    ...
    output: 'var arr = [1, 2, 3, 4];',
    options: ['never'],
    errors: expecting([[0, 22, false, 'before']]),
  },
  {
    code: 'var arr = [ 1, 2, 3, 4];',
    output: 'var arr = [1, 2, 3, 4];',
...
ruleTester.addTestGroup('issue162', 'should handle comments', [
  ...
  },
  {
    ...
    options: ['never'],
    errors: expecting([[0, 27, false, 'before']]),
  },
  {
