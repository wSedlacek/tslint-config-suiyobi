...
ruleTester.addTestGroup(
  'always-valid-objectLiteralComputedProperties',
  'when always, spaces are required inside a computed property name',
  [
...
ruleTester.addTestGroup(
  'always-invalid-objectLiteralComputedProperties',
  'when always, space is required inside object literal computed properties',
  [
    {
      code: 'var x = {[a]: b}',
      output: 'var x = {[ a ]: b}',
...
ruleTester.addTestGroup(
  'never-invalid-objectLiteralComputedProperties',
  'when never, spaces prohibited inside object literal computed properties',
  [
    {
      code: 'var x = {[ a ]: b}',
      output: 'var x = {[a]: b}',
