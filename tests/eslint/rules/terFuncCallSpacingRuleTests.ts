...
ruleTester.addTestGroupWithConfig(
  'specify-as-never',
  'should pass when specifying "never"',
  ['never'],
  [
    'f();',
    'f(a, b);',
...
ruleTester.addTestGroupWithConfig(
  'specify-as-always',
  'should pass when specifying "always"',
  ['always'],
  [
    'f ();',
    'f (a, b);',
...
ruleTester.addTestGroupWithConfig(
  'allow-new-lines',
  'should pass when allowing new lines',
...
ruleTester.addTestGroup('fix-default', 'should remove spaces with default config', [
  {
    code: 'f ();',
    errors: expecting([[0, 1, UNEXPECTED_SPACE]]),
    output: 'f();',
  },
  {
    code: 'f (a, b);',
  ...
  {
    code: 'f.b ();',
    errors: expecting([[0, 3, UNEXPECTED_SPACE]]),
    output: 'f.b();',
  },
  {
    code: 'f.b().c ();',
    errors: expecting([[0, 7, UNEXPECTED_SPACE]]),
    output: 'f.b().c();',
  },
  {
    code: 'f() ()',
  ...
  {
    code: '(function() {} ())',
    errors: expecting([[0, 14, UNEXPECTED_SPACE]]),
    output: '(function() {}())',
  },
  {
    code: 'var f = new Foo ()',
    errors: expecting([[0, 15, UNEXPECTED_SPACE]]),
  ...
  {
    code: 'f(0) (1)',
    errors: expecting([[0, 4, UNEXPECTED_SPACE]]),
    output: 'f(0)(1)',
  },
  {
    code: '(f) (0)',
  ...
  {
    code: 'foo<Bar> ()',
    errors: expecting([[0, 8, UNEXPECTED_SPACE]]),
    output: 'foo<Bar>()',
  },
  {
    code: 'new Foo<Bar> ()',
    errors: expecting([[0, 12, UNEXPECTED_SPACE]]),
    output: 'new Foo<Bar>()',
  },
]);
...
ruleTester.addTestGroupWithConfig(
  'fix-never',
  'should remove spaces when configured as "never"',
  ['never'],
  [
    {
      code: 'f ();',
    ...
    {
      code: 'f\n();',
      errors: expecting([[0, 1, UNEXPECTED_NEWLINE]]),
      output: 'f();',
    },
    {
      code: dedent`
    ...
    `,
      errors: expecting([[2, 23, UNEXPECTED_NEWLINE]]),
      output: dedent`
      this.cancelled.add(request)
    ...
    },
    {
      ...
      errors: expecting([[0, 11, UNEXPECTED_NEWLINE]]),
...
ruleTester.addTestGroupWithConfig(
  'fix-always',
  'should add a space when configured as "always"',
  ['always'],
  [
    {
      code: 'f();',
      errors: expecting([[0, 1, MISSING_SPACE]]),
      output: 'f ();',
    },
    {
      code: 'f\n();',
    ...
    {
      code: 'f.b();',
      errors: expecting([[0, 3, MISSING_SPACE]]),
      output: 'f.b ();',
    },
    {
      code: 'f.b\n();',
    ...
    {
      code: '(function() {}())',
      errors: expecting([[0, 14, MISSING_SPACE]]),
      output: '(function() {} ())',
    },
    {
      code: 'var f = new Foo()',
      errors: expecting([[0, 15, MISSING_SPACE]]),
      output: 'var f = new Foo ()',
    },
    {
      code: 'f( (0) )',
    ...
    {
      code: 'foo<Bar>()',
      errors: expecting([[0, 8, MISSING_SPACE]]),
      output: 'foo<Bar> ()',
    },
    {
      code: 'new Foo<Bar>()',
      errors: expecting([[0, 12, MISSING_SPACE]]),
      output: 'new Foo<Bar> ()',
    },
  ]
);
...
ruleTester.addTestGroupWithConfig(
  'fix-new-lines',
  'should add a space when configured as "always" with new lines',
  ['always', { allowNewLines: true }],
  [
    {
      code: 'f();',
