...
ruleTester.addTestGroup('invalid-7', 'should fail invalid code', [
  {
    ...
    output: '{\na();\n}',
    options: ['never'],
    errors: expecting([['never', 3, 0]]),
  },
  {
    code: '  {\n    a();\n\n  }',
    output: '  {\n    a();\n  }',
    options: ['never'],
    errors: expecting([['never', 3, 2]]),
  },
  {
    code: '{\n// comment\nif (\n// comment\n a) {}\n\n}',
    output: '{\n\n// comment\nif (\n// comment\n a) {}\n\n}',
