  ...
  [
    {
      ...
      errors: expecting([[3, 4, Decl.Func, Root.Func]]),
    },
    {
      code: dedent`
        (function() {
  ...
  [
    {
      ...
      errors: expecting([[2, 2, Decl.Func, Root.Prog]]),
    },
    {
      code: dedent`
        while (test) {
      ...
      errors: expecting([[2, 2, Decl.Var, Root.Prog]]),
    },
    {
      code: dedent`
        function doSomething() {
      ...
      errors: expecting([[3, 4, Decl.Var, Root.Func]]),
    },
    {
      code: dedent`
        (function() {
