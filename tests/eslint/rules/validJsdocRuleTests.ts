...
ruleTester.addTestGroup('invalid', 'should fail when using invalid JSDoc comments (default)', [
  ...
  },
  {
    code: dedent`
       ...
       */
       function foo(){}`,
    errors: expecting(["missing JSDoc parameter type for 'p'", 'missing JSDoc @returns for function']),
  },
  {
    code: dedent`
      /**
       ...
       */
       function foo(){}`,
    errors: expecting(["missing JSDoc parameter description for 'p'", 'missing JSDoc @returns for function']),
  },
  {
    code: dedent`
      /**
  ...
  },
  {
    code: dedent`
       ...
       */
       function foo(){}`,
    errors: expecting(["duplicate JSDoc parameter 'p'", 'missing JSDoc @returns for function']),
  },
  {
    code: dedent`
      /**
  ...
  },
  {
    code: dedent`
       ...
       * @param fields [Array]
        */
        function foo(){}`,
    errors: expecting(["missing JSDoc parameter type for 'fields'", 'missing JSDoc @returns for function']),
  },
  {
    code: dedent`
      /**
    ...
    `,
    errors: expecting(['missing JSDoc @returns for function', "missing JSDoc for parameter 'xs'"]),
  },
]);
  ...
  [
    {
      code: dedent`
        /** Foo
          ...
          */
         function foo(bar){}`,
      errors: expecting(['use @arg instead', 'missing JSDoc @returns for function']),
    },
  ]
);
