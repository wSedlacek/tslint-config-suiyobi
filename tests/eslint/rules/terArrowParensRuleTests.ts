...
ruleTester.addTestGroup('invalid-always', 'should fail with always on', [
  {
    code: 'a => {}',
    output: '(a) => {}',
    errors: expecting([[0, 0, 0, 1, always]]),
  },
  {
    code: 'a => a',
    output: '(a) => a',
  ...
  },
  {
    code: 'a.then(foo => {});',
    output: 'a.then((foo) => {});',
    errors: expecting([[0, 7, 0, 10, always]]),
  },
  {
    code: 'a.then(foo => a);',
    output: 'a.then((foo) => a);',
  ...
  },
  {
    ...
    errors: expecting([[0, 2, 0, 5, always]]),
  },
  {
    code: 'a(async foo => { if (true) {}; });',
    output: 'a(async (foo) => { if (true) {}; });',
    errors: expecting([[0, 8, 0, 11, always]]),
  },
]);
...
ruleTester.addTestGroup('invalid-as-needed', 'should fail with as-needed on', [
  {
    ...
    output: 'a => a',
    options: ['as-needed'],
    errors: expecting([[0, 0, 0, 3, asNeeded]]),
  },
  {
    code: 'async (a) => a',
    output: 'async a => a',
    options: ['as-needed'],
    errors: expecting([[0, 6, 0, 9, asNeeded]]),
  },
]);
...
ruleTester.addTestGroup('invalid-require-for-block', 'should fail when using option', [
  {
    ...
    errors: expecting([[0, 0, 0, 1, blockNoParens]]),
  },
  {
    code: '(a) => a',
    output: 'a => a',
    options: ['as-needed', { requireForBlockBody: true }],
    errors: expecting([[0, 0, 0, 3, block]]),
  },
  {
    code: 'async a => {}',
    output: 'async (a) => {}',
    options: ['as-needed', { requireForBlockBody: true }],
    errors: expecting([[0, 6, 0, 7, blockNoParens]]),
  },
  {
    code: 'async (a) => a',
    output: 'async a => a',
    options: ['as-needed', { requireForBlockBody: true }],
    errors: expecting([[0, 6, 0, 9, block]]),
  },
]);
