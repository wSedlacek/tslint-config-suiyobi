...
ruleTester.addTestGroup('empty-object', 'always with empty object', [{ code: 'var foo = {};', options: ['always'] }]);
...
ruleTester.addTestGroup('empty-object-never', 'never with empty object', [{ code: 'var foo = {};', options: ['never'] }]);
...
ruleTester.addTestGroup('invalid-always-dest', 'invalid always - destructuring trailing comma', [
  {
    ...
    output: 'var { a, } = x;',
    options: ['always'],
    errors: expecting([[0, 8, '}', true]]),
  },
  {
    code: 'var {a, } = x;',
    output: 'var {a,} = x;',
    options: ['never'],
    errors: expecting([[0, 8, '}', false]]),
  },
  {
    code: 'var {a:b } = x;',
    output: 'var {a:b} = x;',
    options: ['never'],
    errors: expecting([[0, 9, '}', false]]),
  },
  {
    code: 'var { a:b } = x;',
    output: 'var {a:b} = x;',
...
ruleTester.addTestGroup('invalid-never-obj-obj', 'invalid never - objects in objects', [
  {
    ...
    errors: expecting([[0, 38, '}', true]]),
  },
  {
    code: "var obj = {'foo': [1, 2] , 'bar': {'baz': 1, 'qux': 2}};",
    output: "var obj = {'foo': [1, 2] , 'bar': {'baz': 1, 'qux': 2} };",
    options: ['never', { objectsInObjects: true }],
    errors: expecting([[0, 54, '}', true]]),
  },
]);
...
ruleTester.addTestGroup('invalid-never-arr-obj', 'invalid never - arrays in objects', [
  {
    ...
    errors: expecting([[0, 24, '}', true]]),
  },
  {
    code: "var obj = {'foo': [1, 2] , 'bar': ['baz', 'qux']};",
    output: "var obj = {'foo': [1, 2] , 'bar': ['baz', 'qux'] };",
    options: ['never', { arraysInObjects: true }],
    errors: expecting([[0, 48, '}', true]]),
  },
]);
...
ruleTester.addTestGroup('invalid-always-never', 'invalid always/never', [
  ...
  },
  {
    ...
    output: 'var obj = { foo: bar, baz: qux };',
    options: ['always'],
    errors: expecting([[0, 10, '{', true]]),
  },
  {
    code: 'var obj = { foo: bar, baz: qux};',
    output: 'var obj = { foo: bar, baz: qux };',
    options: ['always'],
    errors: expecting([[0, 30, '}', true]]),
  },
  {
    code: 'var obj = { foo: bar, baz: qux };',
    output: 'var obj = {foo: bar, baz: qux};',
  ...
  },
  {
    ...
    output: 'var obj = {foo: bar, baz: qux};',
    options: ['never'],
    errors: expecting([[0, 30, '}', false]]),
  },
  {
    code: 'var obj = { foo: bar, baz: qux};',
    output: 'var obj = {foo: bar, baz: qux};',
    options: ['never'],
    errors: expecting([[0, 10, '{', false]]),
  },
  {
