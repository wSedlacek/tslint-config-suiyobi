...
ruleTester.addTestGroup('always', 'should always require an empty line after variable declarations ', [
  ...
  },
  {
    ...
    options: ['always'],
    errors: expecting([['expectedBlankLine', 5]]),
  },
  {
    code: dedent`
  ...
  },
  {
    ...
    output: dedent`
     ...
     value = '';`,
    options: ['always'],
    errors: expecting([['expectedBlankLine', 1]]),
  },
]);
...
ruleTester.addTestGroup('never', 'should disallow empty lines after variable declarations ', [
  ...
  },
  {
    ...
    options: ['never'],
    errors: expecting([['unexpectedBlankLine', 3]]),
  },
  {
    code: dedent`
     class Example {
    ...
    options: ['never'],
    errors: expecting([['unexpectedBlankLine', 5]]),
  },
  {
    code: dedent`
     const dateOfBirth: string = value.slice(1, 9); // yyyymmdd
  ...
  },
  {
    ...
    output: dedent`
     ...
     value = '';`,
    options: ['never'],
    errors: expecting([['unexpectedBlankLine', 1]]),
  },
]);
