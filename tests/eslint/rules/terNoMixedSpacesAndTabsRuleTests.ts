...
ruleTester.addTestGroup('fail-mixed', 'should fail mixed indentation', [
  {
    ...
    options: [],
    errors: expecting([[5, 0, 'indentation has mixed tabs and spaces']]),
  },
  {
    code: dedent`
    function testFn() {
...
ruleTester.addTestGroup('fail-wrong-indent-type', 'should fail spaces in tabs or tabs in spaces', [
  {
    ...
    options: [{ type: 'tabs' }],
    errors: expecting([[5, 0, 'tab indentation expected']]),
  },
  {
    code: dedent`
    function testFn() {
    ...
    options: [{ type: 'spaces' }],
    errors: expecting([[5, 0, 'space indentation expected']]),
  },
  {
    code: dedent`
    function testFn() {
...
ruleTester.addTestGroup('smart-tabs', 'should pass with smart tabs and fail without', [
  {
    ...
    options: [{ type: 'tabs' }],
    errors: expecting([[3, 0, 'tab indentation expected']]),
  },
  {
    code: dedent`
    function testFn() {
